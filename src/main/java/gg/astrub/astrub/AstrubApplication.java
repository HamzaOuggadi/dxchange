...
import gg.astrub.astrub.repositories.ListingProductAccountRepository;
import gg.astrub.astrub.repositories.ListingProductCurrencyRepository;
...
public class AstrubApplication {
	...
	CommandLineRunner start(UserRepository userRepository,
							...
							ListingProductAccountRepository listingProductAccountRepository,
							ListingProductCurrencyRepository listingProductCurrencyRepository) {
		return args -> {
			...
			Stream.of("Vente 300M Kamas", "Vente Compte Cra 200", "Vente 120M Serveur Ilyzaelle").forEach(lst->{
				ListingProductCurrency listingProductCurrency = ListingProductCurrency.builder()
						.currencyAmount(1000000L)
						.build();
				listingProductCurrencyRepository.save(listingProductCurrency);
				Listing listing = Listing.builder()
						...
						.listingProductCurrency(listingProductCurrency)
						.build();
