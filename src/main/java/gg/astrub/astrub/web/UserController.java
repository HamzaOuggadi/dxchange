...
public class UserController {
    ...
    public void addUserProfilePhoto(@RequestParam(name = "userId") Long userId,@RequestParam(name = "profilePhoto") MultipartFile file) throws FileException, UserException, IOException {
